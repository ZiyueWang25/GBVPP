...
CUDA_AVAILABLE_DEVICES=0 python3 infer.py --model_config base_transformer_Layer3 --train_folds 0 --debug 0 --gpu 0
CUDA_AVAILABLE_DEVICES=0 python3 infer.py --model_config base_transformer_bigger --train_folds 0 1 2  --debug 0 --gpu 0
